...
export const TEXT_LEAD_ABOUT =
  'Сервис сбора данных по рекламе, заказам, звонкам и клиентам из рекламных кабинетов в единой связанной системе'
...
export const TEXT_PLACEHOLDER_NAME = 'Имя'
export const TEXT_PLACEHOLDER_LASTNAME = 'Фамилия'
...
export const TEXT_ICON_INFO =
  'Для подключения рекламного кабинета VK ADS заполните “client_id” и “client_secret” в личном кабинете'
...
export const TEXT_SELECT_METRICS =
...
export const CARD_INFO_LEAD = [
  ...
  },
  {
    ...
    subtitle:
      'выполнение медиапланов, контроль недокрутов и перекрутов — ваши бюджеты как на ладони'
  }
]
...
export const GROUPING = ['За всё время', 'Выбор 2']
